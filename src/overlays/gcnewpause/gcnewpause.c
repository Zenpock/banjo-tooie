...
/*void gcnewpause_entrypoint_2(PauseState* a0)
{
	func_800D2574();
	func_800C0438();
	func_800E8A68();

	if ((a0->data[0] - 0x1) > 0x5)
	{
		switch (a0->data[0] - 0x1) {
		case 0x0:
...
void func_80800534_gcnewpause(PauseState* a0, u32 a1)
{
	...
	else if (a0->data[0] == 0x2)
	{
		func_80800E10_gcnewpause(a0, a1);
		_gcnewoption_entrypoint_7(&(a0->optionState));
	}
	else if(a0->data[0] == 0x3)
	{
		_gldbstring_entrypoint_2(0x1864);
