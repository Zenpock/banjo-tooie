...
InventoryDisplay D_808020D8_gcnewpause[] = {//ItemID,UIPos,AbilityID 
	//3C means no ability is tied to it
	{0x49,0x11,0x3C},
	{0x4A,0x12,0x3C},
	{0x48,0x13,0x3C},
	{0x4F,0x14,0x3C},
...
s8 D_80802124_gcnewpause[] = { 0x15,0x11 };
MemorySetupStruct D_80802126_gcnewpause[] = {
	{0xD,0xA,0x7,0x5},
	{0x3,0x2,-1,-1}
};
ItemCountDisplay D_80802130_gcnewpause[] = {
	{0x1,0x8,0x1B},
	{0x2,0xC,0x1C},
	{0x4,0x3B,0x1D},
	{0x3,0xD,0x1E},
...
AbilityTracking D_8080215C_gcnewpause[] = {
	{0x10,0x14},
	{0x10,0x15},
	{0x10,0x16},
	{0x0F,0x19},
...
unk80802190 D_80802190_gcnewpause[6] = {
	{0x6E,0x23,0x0},
	{0x6E,0x91,0x0},
	{0x23,0x23,0x0},
	{0x23,0x23,0x1},
...
u8 D_808021B4_gcnewpause[12] = { 0,0,2,1,4,3,0,5,4,0,0,5 };
s32 D_808021C0_gcnewpause[3] = { 0x00130466,0x001D0018,0x0 };
s32 D_808021CC_gcnewpause[6] = { 0x0,0x0,0x3F000000,0x3F800000,0x3F800000,0x0 };
s32 D_808021E4_gcnewpause[7] = { 0x0,0x0,0x3ECCCCCD,0x3F800000,0x3F800000,0x0,0x0 };

AbilityCheck D_80802224_gcnewpause[] = {
	{0x10,0x36,0x0D,0x14},
	{0x10,0x4C,0x0E,0x15},
	{0x10,0x62,0x0F,0x16},
	{0x10,0x78,0x0B,0x19},
...
AbilityCheck D_8080225C_gcnewpause[] = {
	{0x10,0x36,0x17,0x24},
	{0x10,0x4C,0x15,0x25},
	{0x10,0x62,0x07,0x26},
	{0x10,0x78,0x08,0x27},
...
AbilityCheck D_80802294_gcnewpause[] = {
	{0x0,0xD,0x8,0x0},
	{0x0,0xD,0x8,0x1},
	{0x0,0xD,0x8,0x2},
	{0x0,0xD,0x8,0x4},
