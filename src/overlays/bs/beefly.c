...
#include "core2/1E93440.h" // extern void func_800BBCB8(f32[3], s32, f32, s32, s32 *);
#include "core2/1EB5980.h" // extern f32 func_800DC178(f32, f32);
#include "core2/1E8F430.h" // extern s32 func_800B5BE4(s32);
#include "core2/1E93440.h" // extern s32 func_800BABB8(s32, f32[3], f32[3], f32, s32[]);
#include "core2/1E6B900.h" // extern void func_80093360(PlayerState*, f32);
                           // extern void func_800947EC(PlayerState*, s32, s32);
#include "core2/1E75710.h" // extern void func_8009BF5C(PlayerState*, f32);
#include "core2/1E76360.h" // extern s32 func_8009CA70(PlayerState*, s32, s32);
#include "core2/1E76CC0.h" // extern void func_8009DE38(PlayerState*, s32, f32);
#include "core2/1E75920.h" // extern f32 func_8009C150(PlayerState*);
#include "core2/1E75710.h" // extern f32 func_8009BFD8(PlayerState*);
