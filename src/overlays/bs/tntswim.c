...
void func_80800864_bstntswim(PlayerState* self)
{
    _bsrest_entrypoint_14(self);
    func_80800174_bstntswim(self);
}
void func_8080088C_bstntswim(PlayerState* self)
{
...
void func_8080090C_bstntswim(PlayerState* self)
{
    func_80800114_bstntswim();
    _bsdrone_entrypoint_0(self);
}
void func_80800934_bstntswim(PlayerState* self)
{
    _bsdrone_entrypoint_1();
    _bstnt_entrypoint_4(self);
}
void func_8080095C_bstntswim(PlayerState* self)
{
