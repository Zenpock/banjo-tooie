...
s32 _babackpack_get_size(void);
s32 _babackpack_entrypoint_1(PlayerState *self);
void _babackpack_entrypoint_2(PlayerState *self);
...
void _babackpack_set_state(PlayerState *, BaBackpackState);
