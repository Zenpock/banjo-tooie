...
s32 _batimer_get_size(void);
void _batimer_incrementBy(PlayerState* self, s32 id, f32 arg2);
int _batimer_decrement(PlayerState* self, s32 id);
void _batimer_increment(PlayerState* self, s32 id);
f32 _batimer_get(PlayerState* self, s32 id);
int _batimer_isAt_falling(PlayerState* self, s32 id, f32 time);
int _batimer_isAt_rising(PlayerState* self, s32 id, f32 time);
int _batimer_isLessThan(PlayerState* self, s32 id, f32 time);
int _batimer_isGreaterThan(PlayerState* self, s32 id, f32 time);
int _batimer_isNonzero(PlayerState* self, s32 id);
int _batimer_isZero(PlayerState* self, s32 id);
void _batimer_set(PlayerState* self, s32 id, f32 value);
